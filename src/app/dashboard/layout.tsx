      ...
      <div
        ...
        <nav className="flex flex-col flex-1">
          <ul role="list" className="flex flex-col flex-1 gap-y-7">
            <li>// chats this user is part of</li>
            <li>
              ...
              <ul role="list" className="-mx-2 mt-2 space-y-1">
                {sidebarOptions.map((option) => {
                    ...
                    <span className="text-gray-400 border-gray-200 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.525rem] font-medium">
                      <Icon/>
                    </span>
            ...
            <li className="-mx-6 mt-auto flex items-center">
              <div className="flex  flex-1 items-center gap-x-4 px-6 py-3 text-smfont-semibold leading-6 text-gray-900">
                <div className="relative w-8 h-8 bg-gray-50">
                  <Image fill referrerPolicy="no-referrer" src={session?.user.image || ''} alt="user avatar" className="rounded-full"/>
                </div>
